...
- 케이스 수: **70건** (그중 경계값 케이스 **58건**) · 기계가 읽는 블록 **70건 전부**
...
- **S14** 직전 총급여 50,000,000의 밴드 [2,682,194 , 3,387,500] 안의 **3,000,000**을 골랐다(부양가족 없는 근로자, GC-47 ~ GC-50과 같은 값). 되더할 세액공제액 0. 자르기 전 소득세분 900,000 < 3,000,000 → **자르지 않는다.** 임계값은 900,000이다.
