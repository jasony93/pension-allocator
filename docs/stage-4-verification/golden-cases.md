...
- **32a** — `min(1,350,000, 1,349,999.888) = 1,349,999.888` → 표시 **1,349,999**. 지방세분은 **인정된** 소득세분에 부가율을 곱한다(`local_tax_follows_income_tax_cap`): 1,349,999.888 × 0.1 = 134,999.9888 → **원 미만 버림으로 134,999**. **잘린 금액은 1원이고 그 1원이 `applied`를 참으로 만든다.**
