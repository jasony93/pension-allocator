...
const SLICE_LABEL_NAME_FONT_PX = 16.5;
// 바닥값도 함께 올린다(9×1.1=9.9) — "폴백의 하한을 올리거나"(소유자 지시
// 1번 원문)의 그 하한. 그래도 여전히 바닥이지 목표가 아니다 — 정상 경로는
// 위 기본 크기(16.5px)에서 끝나야 한다.
const SLICE_LABEL_MIN_FONT_PX = 9.9;
