...
/**
 * [D79 판정 2] 김철수씨 값으로 미리 채워 시작한다는 사실을 화면에 남긴다 —
 * "그 결과가 미리 채운 인물의 것임이 화면에 있어야 한다." 값을 직접 고치면
 * 이 줄이 사라지는 것까지는 요구되지 않는다(관리자 지시 원문 "단순하게").
 */
export const CALC2_PREFILL_NOTE = '김철수씨의 예시 값으로 시작합니다 — 직접 고쳐 보세요.';
